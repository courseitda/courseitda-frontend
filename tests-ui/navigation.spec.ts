 ...
 * ✅ 테스트하는 것 (프론트엔드 UI/UX):
 * - 프로필 드롭다운 메뉴 표시
 * - 프로필 메뉴 항목 (마이페이지, 워크스페이스, 로그아웃) 표시
 * - 사용자 정보 (닉네임, 이메일) 표시
 ...
 * 2. 프로필 메뉴에서 로그아웃할 수 있다
 * 3. 워크스페이스 상세 페이지에서 뒤로가기 버튼이 작동한다
 * 4. 워크스페이스 상세 페이지에서 워크스페이스 전환 드롭다운이 작동한다
 * 5. 워크스페이스 전환 드롭다운에서 새 워크스페이스를 생성할 수 있다
 * 6. 워크스페이스 목록 페이지에서 로고 클릭 시 랜딩 페이지로 이동한다
 * 7. 프로필 메뉴에서 워크스페이스 메뉴를 클릭하면 워크스페이스 목록으로 이동한다
 *
