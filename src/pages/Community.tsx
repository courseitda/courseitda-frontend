...
import { Archive, LogOut, Search, User as UserIcon, ArrowLeft, Folder } from 'lucide-react';
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      <Heart
                        className={`w-6 h-6 ${isAuthenticated ? 'text-primary' : 'text-muted-foreground'} transition-transform duration-150 ${likePulse[category.id] ? 'scale-110' : ''}`}
